 ...
 */
	public function create($model = null, $options = array()) {
        ...
        /**
         * CUSTOM CODE FOR IFRAME FORM VALIDATION.
         */
		$append .= $this->hidden('_form_id', array('value'=>$options['id'], 'name'=>'_form_id'));
		$append .= $this->hidden('_model', array('value'=>$model, 'name'=>'_model'));
 ...
 */
	...
	public function getSeoTag() {
	    ...
	    $title = 'テーラーメッド';
	    $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト,がん,遺伝子検査,ゲノム検査,クリニカルシーケンス,クリニカルシークエンス,プレシジョン・メディシン,プレシジョンメディシン,スローンケタリング,緒方憲太郎,緒方';
	    $description = 'テーラーメッドは世界最高峰のがん遺伝子検査であるMSK-IMPACTを日本初導入いたしました。１度の検査で468個のがん関連遺伝子情報を調べることができ，がん関連遺伝子変異を網羅的に解析することにより，患者様に最適な正しい治療法へと導きます。';
	    $canonical = '';
	    $index = true;
	    //トップ
	    if (strpos($checkUrl,'announcements/home') !== false) {
	        $title = 'テーラーメッド';
    	    $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト,がん,遺伝子検査,ゲノム検査,クリニカルシーケンス,クリニカルシークエンス,プレシジョン・メディシン,プレシジョンメディシン,スローンケタリング,緒方憲太郎,緒方';
    	    $description = 'テーラーメッドは世界最高峰のがん遺伝子検査であるMSK-IMPACTを日本初導入いたしました。１度の検査で468個のがん関連遺伝子情報を調べることができ，がん関連遺伝子変異を網羅的に解析することにより，患者様に最適な正しい治療法へと導きます。';
	    } elseif (strpos($checkUrl,'pages/company') !== false) {
	        $title = '企業情報a';
	        $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト,がん,遺伝子検査,ゲノム検査,スローンケタリング';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| 企業情報';
	    } elseif (strpos($checkUrl,'pages/greetings') !== false) {
	        $title = 'ご挨拶';
	        $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト,がん,遺伝子検査,ゲノム検査,スローンケタリング';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| ご挨拶';
	        $canonical = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/pages/company';
	    } elseif (strpos($checkUrl,'pages/philosophy') !== false) {
	        $title = '経営理念';
	        $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト,がん,遺伝子検査,ゲノム検査,スローンケタリング';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| 経営理念';
	        $canonical = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/pages/company';
	    } elseif (strpos($checkUrl,'pages/about') !== false) {
	        $title = 'MSK-IMPACT検査とは';
	        $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト,がん,遺伝子検査,ゲノム検査,スローンケタリング';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| MSK-IMPACT検査とは';
	    } elseif (strpos($checkUrl,'pages/flow') !== false) {
	        $title = '検査の流れ';
	        $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト,がん,遺伝子検査,ゲノム検査,スローンケタリング';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| 検査の流れ';
	        $canonical = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/pages/about';
	    } elseif (strpos($checkUrl,'pages/pricing') !== false) {
	        $title = '費用について';
	        $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト,がん,遺伝子検査,ゲノム検査,スローンケタリング,費用,料金';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| 費用について';
	        $canonical = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/pages/about';
	    } elseif (strpos($checkUrl,'consultations/add') !== false) {
	        //noindex,nofollow
	        $index = false;
	    } elseif (strpos($checkUrl,'pages/research') !== false) {
	        $title = '共同研究';
	        $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| 共同研究';
	    } elseif (strpos($checkUrl,'pages/evidence') !== false) {
	        $title = 'IMPACTに関する報告';
	        $keyword = 'TailorMed,テーラーメッド,MSK-IMPACT,エムエスケイインパクト';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| IMPACTに関する報告';
	        $canonical = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . '/pages/research';
	    } elseif (strpos($checkUrl,'academia_supports/add') !== false) {
	        //noindex,nofollow
	        $index = false;
	    } elseif (strpos($checkUrl,'pages/link') !== false) {
	        $title = 'リンク';
	        $keyword = 'TailorMed,テーラーメッド';
	        $description = 'テーラーメッドは世界最高峰のがんゲノム検査であるMSK-IMPACTを日本初導入いたしました。従来検査法では同定されなかった患者一人一人のがんの特徴を浮き彫りにし、正しい治療法へと導きます。| リンク';
	    }

	    $tag .= '<title>' . $title . '</title>' . PHP_EOL;
	    $tag .= '<meta charset="UTF-8" />' . PHP_EOL;
	    $tag .= '<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />' . PHP_EOL;
	    $tag .= '<meta name="format-detection" content="telephone=no" />' . PHP_EOL;

	    $tag .= '<meta name="keywords" content="' . $keyword . '" />' . PHP_EOL;
	    $tag .= '<meta name="description" content="' . $description . '" />' . PHP_EOL;
	    if ($canonical) {
	        $tag .= '<link rel="canonical" href="' . $canonical . '">' . PHP_EOL;
	        $tag .= '<meta name="robots" content="noindex,follow">' . PHP_EOL;
	    } else {
	        if ($index) {
	            $tag .= '<meta name="robots" content="index,follow">' . PHP_EOL;
	        } else {
	    ...
	    if ($index) {
	        $tag .= '<meta property="og:type" content="website" />' . PHP_EOL;
	        $tag .= '<meta property="og:title" content="テーラーメッド" />' . PHP_EOL;
	        $tag .= '<meta property="og:image" content="http://tailor-med.com/images/logofb.png" />' . PHP_EOL;
	        $tag .= '<meta property="og:description" content="' . $description . '" />' . PHP_EOL;
	    }
