	...
	<div class="clearfix">
		<div class="columns columns_3 page_margin_top_section clearfix">
			<ul class="column">
				<li class="item_content clearfix">
					<a class="features_image" href="#" title="">
						<img src="images/features_small/lab.png" alt="" class="animated_element animation-scale" />
					</a>
					<div class="text">
						<h3>
			...
			<ul class="column">
				<li class="item_content clearfix">
					<a class="features_image" href="#" title="">
						<img src="images/features_small/plaster.png" alt="" class="animated_element animation-scale" />
					</a>
					<div class="text">
						<h3>
							<a href="?page=about" title="Lorem ipsum">
